...
function Resources() {
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-8 p-8 text-center">
      ...
      <Dialog>
        ...
        <div
          className="grid grid-cols-[repeat(auto-fit,minmax(16rem,1fr))] items-center justify-center gap-4"
          ref={cardsContainer}
        >
