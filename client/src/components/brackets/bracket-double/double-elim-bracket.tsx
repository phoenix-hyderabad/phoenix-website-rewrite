            ...
            <g>
              ...
              <FinalGame
                {...{
                  ...
                  bracketSnippet: {
                    previousTopMatch: upperColumns[upperColumns.length - 1]
                      ? upperColumns[upperColumns.length - 1][0]
                      : undefined,
                    previousBottomMatch: lowerColumns[lowerColumns.length - 1]
